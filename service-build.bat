...
rem 执行 cwgo 命令启动服务
cwgo server --type %SERVICE_TYPE% --idl ../idl/%SERVICE_IDL% --service %SERVICE_NAME% --module %SERVICE_MODULE_NAME%
