...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserPasswordHash = field.NewString(tableName, "user_password_hash")
	_user.Email = field.NewString(tableName, "email")
	_user.PersonalizedSignature = field.NewString(tableName, "personalized_signature")
...
type user struct {
	...
	UserPasswordHash      field.String
	Email                 field.String
	PersonalizedSignature field.String
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserPasswordHash = field.NewString(table, "user_password_hash")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_password_hash"] = u.UserPasswordHash
